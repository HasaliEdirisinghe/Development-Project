...
$sql_query = "UPDATE property 
            SET PropertyType = '$propertytype', ProjectName = '$projectname', Location = '$location', District = '$district', Address = '$address', LotNo = '$lot_no',  
                BedRooms = '$br', PlanNo = '$plan_no', Size = '$size', UnitPrice = '$price', TotalPrice = '$total_price'
            WHERE PropertyID = '$id';";
