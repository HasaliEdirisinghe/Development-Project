...
$sql_query = "UPDATE property 
            SET PropertyType = '$propertytype', ProjectName = '$projectname', Location = '$location', District = '$district', Address = '$address',
                BedRooms = '$br', PlanNo = '$plan_no', HouseArea = '$area', UnitPrice = '$total_price', TotalPrice = '$total_price'
            WHERE PropertyID = '$id';";
